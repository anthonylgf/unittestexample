...
class AlunoControllerTest {
  ...
  public void criarAluno_ComDadosValidos_RetornarAlunoComStatus204() throws Exception {
                ...
                .contentType(
                    MediaType
                        .APPLICATION_JSON) // .Define o cabeçalho Content-Type da requisição enviada
                                           // ao controller.
                .content(
                    jsonDeEntrada) // Define o corpo (body) da requisição HTTP que será
    ...
    verify(service)
        .salvar(
            any(
                Aluno
                    .class)); // Confirma que o metodo salvar() no service foi chamado exatamente
  ...
  public void buscarAluno_ComIdExistente_RetornarAlunoComStatus200()
      throws
          Exception { // Pode melhorar fazendo verificar se o JSON retornado está correto e se o
