  ...
  public class AlunoStepDefs {
    ...
    @Autowired
    private AlunoPublisher alunoPublisher;
    ...
    public void retorneUmaListaDeAlunosDoGeneroFiltrado() {
        ...
        Assertions.assertEquals(this.generoFiltro, pageAlunos.getContent().get(0).getGenero(), "O gênero do aluno filtrado deve ser " + this.generoFiltro.name());
